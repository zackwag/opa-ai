...
export default function PropertyMap({ subject, comps, radius }) {
    ...
    return (
        <div className="map-container">
            <MapContainer center={[subject.lat, subject.lng]} zoom={16} style={{ height: '400px', width: '100%', borderRadius: '12px' }}>
                <TileLayer attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors' url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
                <FitBounds subject={subject} comps={comps} />
                <Circle center={[subject.lat, subject.lng]} radius={radius} pathOptions={{ color: '#2563eb', fillColor: '#2563eb', fillOpacity: 0.05, weight: 1 }} />
